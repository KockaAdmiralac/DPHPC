...
open_implementations = ['openmp_base', 'openmp_base_opt', 'openmp_block']
...
mpi_df_4000 = mpi_df.loc[mpi_df['N2']==4000] #better than 8 discuss
...
plot_list = [mpi_implementations, cuda_implementations, serial_implementations, open_implementations, mpi_implementations]
df_list = [mpi_df_8, cuda_df, serial_df, open_df_8, mpi_df_4000]
filename_list = ['mpi_t_8', 'cuda', 'serial', 'open_t_8', 'mpi_n_4000']
title_list = ['ADI MPI - 8 processes', 'ADI cuda', 'ADI serial', 'ADI OpenMp - 8 threads', 'ADI MPI - N = 4000']
