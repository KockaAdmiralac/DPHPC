...
def plotting(directory, mpi_implementations, cuda_implementations, serial_implementations, open_implementations, 
             threads, N2, N2_c, filename_list, title_list, plot_path, set_threads, set_n2, gemver = True):
    data = []
    implementations = cuda_implementations + mpi_implementations + serial_implementations + open_implementations
...
plotting(adi_dictionary["directory"], adi_dictionary["mpi_implementations"], adi_dictionary["cuda_implementations"], adi_dictionary["serial_implementations"], adi_dictionary["open_implementations"], 
         adi_dictionary["threads"], adi_dictionary["N2"], adi_dictionary["N2_c"], adi_dictionary["filename_list"], adi_dictionary["title_list"], adi_dictionary["plot_path"], adi_dictionary["set_threads"], adi_dictionary["set_n2"], False);
p = os.path.join("plot", "gemver.json")
with open(p) as f:
    gem_dictionary = json.load(f)
plotting(gem_dictionary["directory"], gem_dictionary["mpi_implementations"], gem_dictionary["cuda_implementations"], gem_dictionary["serial_implementations"], gem_dictionary["open_implementations"], 
         gem_dictionary["threads"], gem_dictionary["N2"], gem_dictionary["N2_c"], gem_dictionary["filename_list"], gem_dictionary["title_list"], gem_dictionary["plot_path"], gem_dictionary["set_threads"], gem_dictionary["set_n2"]);